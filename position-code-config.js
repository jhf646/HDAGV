window.AGV_APP_CONFIG = {
  ...
  endpoints: [
    {id:'genAgvSchedulingTask', name:'生成任务单', path:'/rcms/services/rest/hikRpcService/genAgvSchedulingTask', method:'POST', headers:{'Content-Type':'application/json'}, sample:{"reqCode": "B0344592BD76C8F","taskTyp": "A01","positionCodePath": [{"positionCode": "3001","type": "00"},{"positionCode": "3002","type": "00"}]}} ,
    ...
    {id:'queryTaskStatus', name:'查询任务状态', path:'/rcms/services/rest/hikRpcService/queryTaskStatus', method:'POST', headers:{'Content-Type':'application/json'}, sample:{"reqCode":"test01","agvCode":"1","taskCodes":[""]}} ,
    {id:'queryAgvStatus', name:'查询Agv状态', path:'/rcms-dps/rest/queryAgvStatus', method:'POST', headers:{'Content-Type':'application/json'}, sample:{"reqCode":"1","mapShortName":"QQ","robotCount":"-1"}} ,
...
// 5，二分厂二楼
        positionCode: [
          { label: '仓库二楼1号', value: '5001' },
          { label: '仓库二楼2号', value: '5002' },
          { label: '仓库二楼3号', value: '5003' },
          { label: '仓库二楼4号', value: '5004' },
          { label: '锭子1号', value: '3001' },
          { label: '锭子2号', value: '3002' },
          { label: '锭子3号', value: '3003' },
          { label: '锭子4号', value: '3004' },
          { label: '动平衡1号', value: '4001' },
          { label: '动平衡2号', value: '4002' },
          { label: '动平衡3号', value: '4003' },
          { label: '动平衡4号', value: '4004' },
          { label: '假捻器1号', value: '2001' },
          { label: '假捻器2号', value: '2002' },
          { label: '假捻器3号', value: '2003' },
          { label: '假捻器4号', value: '2004' },
          ...
          { label: "仓库一楼1号", value: "10002" },
          { label: "仓库一楼2号", value: "10003" },
          { label: "生产一楼1号", value: "10004" },
          { label: "生产一楼2号", value: "10005" },
        ]
      }
    }
  }
